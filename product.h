 ...
 public:
  ...
  friend class product;
   ...
   private:
     ...
     */
    explicit iterator(typename C2::const_iterator,
...
inline typename product<C1, C2>::iterator product<C1, C2>::end() const {
  return iterator(container_2.cbegin(), container_2.cend(),
                  container_1.cend(), container_2.cbegin());
}
...
inline product<C1, C2>::iterator::iterator(typename C2::const_iterator c2_b,
    ...
    : c2_begin(c2_b), c2_end(c2_e),
      c1_current(c1_c), c2_current(c2_c) {}

template <typename C1, typename C2>
inline typename product<C1, C2>::iterator &
product<C1, C2>::iterator::operator++() {
...
template <typename C1, typename C2>
inline typename product<C1, C2>::iterator
product<C1, C2>::iterator::operator++(int) {
  auto temp(*this);
  this->operator++();
  return temp;
}
